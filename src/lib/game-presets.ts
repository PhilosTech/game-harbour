...
export const HERO_SIGNATURE_SUGGESTIONS: Record<
  string,
  HeroSignatureSuggestion
> = {
  doctor: {
    strength: { key: "medicine", labelRu: "Медицина", labelEn: "Medicine" },
    weakness: {
      key: "impulsive",
      labelRu: "Импульсивность",
      labelEn: "Impulsive",
    },
  },
  engineer: {
  ...
  journalist: {
    ...
    weakness: {
      key: "trusting",
      labelRu: "Доверчивость",
      labelEn: "Too trusting",
    },
  },
  guide: {
    strength: {
